...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('techpack_comments')) {
            Schema::create('techpack_comments', function (Blueprint $table) {
                $table->bigIncrements('id');
                $table->bigInteger('techpack_id')->default(0);
                $table->integer('company_id')->default(0);
                $table->integer('workspace_id')->default(0);
                $table->string('techpack_type',100)->nullable();
                ...
                $table->index(['company_id','workspace_id','techpack_id'],'techpack_comments_idx');
            });
        }
    }
