...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('inquiry_new_po')) {
            Schema::create('inquiry_new_po', function (Blueprint $table) {
                ...
                $table->timestamps();
                $table->index(['company_id','workspace_id','user_id','staff_id','article_id','status','parent_id'],'inquiry_new_po_main_idx');
            });
        }
    }
