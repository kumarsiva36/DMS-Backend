...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('inquiry_media')) {
            Schema::create('inquiry_media', function (Blueprint $table) {
                ...
                $table->timestamps();
                $table->index(['temp_id','inquiry_id','company_id','workspace_id','media_type'],'inquiry_media_main_idx');
            });
        }
    }
