...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('inquiry_po')) {
            Schema::create('inquiry_po', function (Blueprint $table) {
                ...
                $table->tinyInteger('po_status')->default(0)->comment("'1'=>Active,'2'=>Cancelled,'3'=>Deleted");
                $table->tinyInteger('is_po_confirmed')->default(0);
                ...
                $table->timestamps();
                $table->index(['inquiry_id','factory_id','article_id','user_id','staff_id','company_id','workspace_id','fabric_type_id','created_at'],'inquiry_po_main_idx');
            });
        }
    }
