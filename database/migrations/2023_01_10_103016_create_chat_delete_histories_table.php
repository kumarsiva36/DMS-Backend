...
class CreateChatDeleteHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('chat_delete_histories', function (Blueprint $table) {
            ...
            $table->index(['id','company_id','workspace_id']);
        });
    }
    ...
    {
        Schema::dropIfExists('chat_delete_histories');
    }
}
