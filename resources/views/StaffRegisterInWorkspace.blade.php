...
<head>
    ...
    <title>Staff Invite to Workspace</title>
        ...
        <div class="wrapper" style="margin:50px 0;padding:20px 0">
          ...
          <div style="border:1px solid #eee; padding: 0px 10px 05px 10px;  ">
            <div style="line-height:25px;margin:10px 0px 0px 5px;">
                ...
                {{-- <span style="color: #188676; font-size:18px;"><strong>{{ strtr(trans('WebSite1.Dear'),[':user'=>$details['userName']])  }},</strong></span> --}}
            </div>
            <div style="margin-top: 35px;">
                <div>
                    <img src="{{ $message->embed(public_path().'/images/StaffInviteWorkspace.png') }}" class="center">
                    {{-- <img src="{{ asset('images/StaffInviteWorkspace.png') }}" class="center"> --}}
                </div>
                <div style="font-weight: 600; color: #188676;text-align:center; font-size:20px; margin-bottom:10px;">{{ trans('WebSite.workspaceInvite') }}</div>
                <div style="margin:0px 5px">
                    <p>{!! trans('WebSite.workspaceInviteText',['workspaceName'=>$details['workspaceName']]) !!}</p>
                    <p>{!! trans('WebSite.accessWebVersion') !!}</p>
                </div>
            </div>
        </div>
