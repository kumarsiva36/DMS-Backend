...
<head>
    ...
    <title>User Trial Plan Expired</title>
            ...
            <div style="border:1px solid #eee; padding: 0px 10px 05px 10px;">
                ...
                <div style="margin-top: 35px;">
                    ...
                    <div style="font-weight: 500; color: #CD3120;text-align:center; font-size:20px;margin-top: 10px;">
                        {{ trans('WebSite.trailEnded') }}</div>
                    <div style="margin:0px;text-align:center;">
                        <p style="margin:0px; font-size:12px;">{{ trans('WebSite.trailEndedText') }}</p>
                    </div>
                    <div style="text-align: center; margin: 10px 0px;">
                        <a href="{{ config('app.app_url') . 'pricing' }}">
                            <input type="button" value="View plan options" class="btnPlan">
                        </a>
                    </div>
                </div>
            </div>
