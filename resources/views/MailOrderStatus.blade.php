                ...
                <table width="100%" style="border-collapse: collapse;">
                    <tr>
                        <td style="border:1px solid #E8E8E8; padding:5px 15px 15px;">
                            ...
                            <div style="font-weight: 600; color: #188676;text-align:center; font-size:20px; ">Order Status</div>
                            ...
                            @foreach ($details_arr as $details)
                                @if(isset($details['orderNo']))
                                    ...
                                    <div style="margin: 0; padding:0">
                                        ...
                                        @php $jj++; @endphp
                                        <table style="width :100%; border-collapse: collapse;" class="DataTable">
                                                    ...
                                                    <tr>
                                                        ...
                                                        @elseif ($detail['days'] >0 && $detail['type'] === 'Progress')
                                                            @if ($detail['days'] == 1)
                                                                ...
                                                                <td class="tableClass" ><span>{{ trans('WebSite.DayRemaining') }}</span></td>
                                                            @else
                                                                <td style="text-align:center; background-color: #ffffff;padding-left:0px;">
                                                                    <img src="{{ $message->embed(public_path().'/images/SmileyYellow.png') }}" width="{{config('constant.mail_icon_width')}}" />
                                                                </td>
                                                                <td class="tableClass" ><span>{{ trans('WebSite.DaysRemaining',["days"=>$detail['days']]) }}</span></td>
                                                            @endif
                                                        @elseif ($detail['days']===0 && $detail['type'] === 'Progress')
                                                            <td style="text-align:center; background-color: #ffffff;padding-left:0px;">
                                                                <img src="{{ $message->embed(public_path().'/images/SmileyYellow.png') }}" width="{{config('constant.mail_icon_width')}}" />
                                                            </td>
                                                            <td class="tableClass" ><span>{{ trans('WebSite.LastDay') }}</span></td>
                                                        @elseif ($detail['days'] <0 && $detail['type'] === 'Progress')
                                                            @if ($detail['days']== -1)
                                                                <td style="text-align:center; background-color: #ffffff;padding-left:0px;">
                                                                    <img src="{{ $message->embed(public_path().'/images/2_Days_Delay.png') }}" width="{{config('constant.mail_icon_width')}}" />
                                                                </td>
                                                                <td class="tableClass" ><span>{{ abs($detail['days'])." ".trans('WebSite.dayDelay') }}</span></td>
                                                            @elseif (abs($detail['days'])<=3)
                                                                <td style="text-align:center; background-color: #ffffff;padding-left:0px;">
                                                                    <img src="{{ $message->embed(public_path().'/images/2_Days_Delay.png') }}" width="{{config('constant.mail_icon_width')}}" />
                                                                </td>
                                                                <td class="tableClass" ><span>{{ abs($detail['days'])." ".trans('WebSite.daysDelay') }}</span></td>
                                                            @else
                                                                <td style="text-align:center; background-color: #ffffff;padding-left:0px;">
                                        ...
                                        @if (in_array("prodData",(array_keys($details))))
                                            ...
                                            <table style="width :100%;font-family: 'Roboto', sans-serif; " class="DataTable">
                                                ...
                                                <th class="tableClass" ><span>{{ trans('WebSite.StartDate') }}</span></th>
                                                <th class="tableClass" ><span>{{ trans('WebSite.EndDate') }}</span></th>
                                                <th class="tableClass" ><span>{{ trans('WebSite.Total') }}</span></th>
                                                <th class="tableClass" ><span>{{ trans('WebSite.Completed') }}</span></th>
                                                <th class="tableClass" ><span>{{ trans('WebSite.Pending') }}</span></th>
                                                <th class="tableClass" ><span>{{ trans('WebSite.Status') }}</span></th>
                                                <th class="tableClass" ><span>{{ trans('WebSite.Result') }}</span></th>
                                                @foreach ($details['prodData'] as $detail )
                                                    <tr>
                                                        ...
                                                        <td class="tableClass" ><span>{{ $detail['startDate']!=''?$detail['startDate']:'---' }}</span></td>
                                                        <td class="tableClass" ><span>{{ $detail['endDate']!=''?$detail['endDate']:'---' }}</span></td>
                                                        <td class="tableClass" ><span>{{ $detail['totalQuantity'] }}</span></td>
                                                        <td class="tableClass" ><span>{{ $detail['updatedQuantity'] }}</span></td>
                                                        <td class="tableClass" ><span>{{ $detail['pendingQuantity'] }}</span></td>
                                                        ...
                                                        @elseif ($detail['delay'] > 0 && $detail['type'] ==="Progress")
                                                            ...
                                                            @else
                                                                ...
                                                                <td class="tableClass" ><span>{{ trans('WebSite.DaysRemaining',['days'=>$detail['delay']]) }}</span></td>
                                                            @endif
                                                        @elseif ($detail['delay'] === 0 && $detail['type'] ==="Progress")
                                                            <td style="text-align:center; background-color: #ffffff;padding-left:0px;">
                                                                <img src="{{ $message->embed(public_path() . '/images/clockYellow.png') }}" width="{{config('constant.mail_icon_width')}}" />
                                                            </td>
                                                            <td class="tableClass" ><span>{{ trans('WebSite.LastDay') }}</span></td>
                                                        @elseif ($detail['delay'] < 0 && $detail['type'] ==="Progress")
                                                            @if ($detail['delay'] == -1)
                                                                ...
                                                                <td class="tableClass" ><span>{{ abs($detail['delay'])." ".trans('WebSite.dayDelay') }}</span></td>
                                                            @elseif (abs($detail['delay'])<=3)
                                                                <td style="text-align:center; background-color: #ffffff;padding-left:0px;">
                                                                    <img src="{{ $message->embed(public_path().'/images/2_Days_Delay.png') }}" width="{{config('constant.mail_icon_width')}}" />
                                                                </td>
                                                                <td class="tableClass" ><span>{{ abs($detail['delay'])." ".trans('WebSite.daysDelay') }}</span></td>
                                                            @else
                                                                <td style="text-align:center; background-color: #ffffff;padding-left:0px;">
                                                                    <img src="{{ $message->embed(public_path() . '/images/delay_bomb.png') }}" width="{{config('constant.mail_icon_width')}}" />
                                                                </td>
