...
<body style="font-family: poppins,arialuni; font-size: 14px;">
    ...
    <div style="margin: 5px 0;">
        @if (count($data['advFilter'])>0)
            ...
            @endif
            @if (array_key_exists("fabric",$data['advFilter']))
                <strong style="background-color: #E8E8E8;color:#606060;padding:1px 3px 3px;">
                    {{ trans('WebSite.fabric_composition').": ".$data['advFilter']['fabric'] }}</strong>
            @endif
            @if (array_key_exists("incoterms_name",$data['advFilter']))
                <strong style="background-color: #E8E8E8;color:#606060;padding:1px 3px 3px;">
                    {{ trans('WebSite.income_terms').": ".$data['advFilter']['incoterms_name'] }}</strong>
            @endif
    ...
    <tr style="background-color: #C4E1DD; color: #178677; font-weight:600;">
        ...
        <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp,poppins-semibold;"><strong>Purchase Order ID</strong></td>
        ...
        <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp,poppins-semibold;"><strong>Status</strong></td>
    ...
    @foreach ($data['inquiries'] as $index=>$inquiry)
        <tr>
            ...
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;">{{ $inquiry['po_number']==NULL ? "PO-".$inquiry['po_id'] : "PO-".$inquiry['po_number'] }}</td>
            ...
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;"><strong>{{ $inquiry['status']==1 ? 'Published':'Unpublished' }}</strong></td>
