                                    ...
                                    <table style="width :100%;font-family: 'Roboto', sans-serif;" id="DataTable" >
                                        ...
                                        @foreach ($details['taskDetails'][$j] as $detail)
                                            <tr>
                                                ...
                                                <td class="tableClass" style="font-family: 'Roboto', sans-serif;">{{ trans('WebSite.tomorrow') }}</td>
                                            </tr>
                                        @endforeach
                                    </table>
                                @endfor
                    ...
                    <table style="width :100%;font-family: 'Roboto', sans-serif;" id="DataTable">
                        ...
                        @foreach ($details['taskDetails'][$j] as $detail)
                            ...
                            <tr>
                                ...
                                <td class="tableClass" style="font-family: 'Roboto', sans-serif;"><span>{{ trans('WebSite.tomorrow') }}</span></td>
                            </tr>
                        @endforeach
                    </table>
                @endfor
