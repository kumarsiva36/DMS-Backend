        ...
        <div class="wrapper" style="margin:50px 0;padding:20px 0">
          ...
          <div style="border:1px solid #eee; padding: 0px 10px 05px 10px;  ">
            <div style="line-height:25px;margin:10px 0px 0px 5px;">
                <span style="color: #188676; font-size:18px;"><strong> Dear User,
                    {{-- {{ trans('WebSite.Dear',['user'=>trim($details['created_by'])]) }}, --}}
                </strong></span><br><br>
                {{-- Please find enclosed our detailed inquiry for below mentioned. Please workthrough all details carefully and send us your best offer. If something in your offer will differ from this inquiry please let us know exactly what you otherwise we will take our requests as granted! --}}
                {!! $details['content'] !!}
                <br><br>
            </div>
