...
<head>
    ...
    <title>Order Task Daily Reminder Mail</title>
        ...
        <div class="wrapper" style="margin:50px 0;padding:20px 0">
          ...
          <div style="border:1px solid #eee; padding: 0px 10px 05px 10px;  ">
            <div style="line-height:25px;margin:10px 0px 0px 5px;">
                ...
                {{ trans('WebSite.taskDailyReminder') }}
            </div>
            <div style="margin-top: 35px;">
                ...
                @for($j=0; $j < $details['count']; $j++)
                    <table style="width :100%; border-collapse: collapse;font-family: 'Roboto', sans-serif;margin-top:35px" cellpadding="5px">
                        <tr>
                            <td style="text-align: left; width: 25%;font-size:14px;font-weight:500;font-family: 'Roboto', sans-serif;">
                                {{-- Order Number  <strong>{{ $details['orderNo'] }}</strong> --}}
                            {{ trans('WebSite.Order')." / ".trans('WebSite.Style') }}
                            </td>
                            <td style="text-align: left; width: 45%;font-size:14px;font-weight:500;font-family: 'Roboto', sans-serif;">
                                <strong>{{ $details['orderNo'][$j] }}</strong> / <strong>{{ $details['styleNo'][$j] }}</strong>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="text-align: left; font-size:14px;font-weight:500;font-family: 'Roboto', sans-serif;">
                                <strong>{{ date($details['dateFormat'],strtotime($details['delivery_date'][$j])) }}</strong>
                            </td>
                        </tr>
                    </table>
