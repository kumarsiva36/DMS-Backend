...
<head>
    ...
    <title>Delayed Order Status Mail</title>
                    ...
                    <tr>
                        <td style="border:1px solid #E8E8E8; padding:5px 15px 15px;">
                            ...
                            <div style="text-align: center;">
                                <img src="{{ $message->embed(public_path().'/images/OrderDelay.png') }}" width="59" height="59" style="padding-top: 25px;">
                            </div>
                            <div style="font-weight: 600; color: #188676;text-align:center; font-size:20px; ">{{ trans('WebSite.orderDelayText') }}</div>
                            @php $jj=0; @endphp
                                        ...
                                        <table style="width :100%; border-collapse: collapse;"  class="DataTable">
                                            <tr style="background-color: #c9c7c7">
                                                ...
                                                <td style="text-align: right; width: 33%;font-size:14px;font-weight:500;font-family: 'Roboto', sans-serif; padding:7px">
                                                    {{ trans('WebSite.delivery_date') }} : {{ $details['delivery_date'] }}
                                                </td>
                                            </tr>
                                        </table>
                                        {{-- Task Data Table --}}
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($detail['status']=== "Delay")
                                                                @if ($detail['noOfDays'] == -1)
                                                                    ...
                                                                    <td class="tableClass" ><span>{{ abs($detail['noOfDays'])." ".trans('WebSite.dayDelay') }}</span></td>
                                                                ...
                                                                @elseif (abs($detail['noOfDays']) <= 3)
                                                                    ...
                                                                    <td class="tableClass" ><span>{{ abs($detail['noOfDays'])." ".trans('WebSite.daysDelay') }}</span></td>
                                                                @else
                                                                    <td style="text-align:center; background-color: #ffffff;padding-left:0px;">
                                        ...
                                        @if (in_array("prodData",(array_keys($details))))
                                            ...
                                            <table style="width :100%;font-family: 'Roboto', sans-serif;" class="DataTable">
                                                ...
                                                @foreach ($details['prodData'] as $detail )
                                                    <tr>
                                                        <td style="text-align:center;font-family: 'Roboto', sans-serif;padding:0;">{{ $j }}</td>
