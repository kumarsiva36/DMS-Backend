<?php   use \App\Http\Controllers\Website\Common\Helper; ?>
<!DOCTYPE html>
<html lang="en">
...
<body style="font-family: poppins,arialuni; font-size: 14px;">
    ...
    cellspacing="1px" class="mainTable">
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{{ Helper::translate($datas['inqdet'][0]['article_name'],$trans_arr) }}</td>
        </tr>
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            <td style="padding : 5px ; font-family: poppins,arialuni;width:30%"><strong>{{ trans('WebSite.style_number') }}</strong></td>
            <td style="padding : 5px ; font-family: poppins,arialuni;">{{ Helper::translate($datas['data']['style_no'],$trans_arr) }}</td>
        </tr>
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            <td style="padding : 5px ; font-family: poppins,arialuni;width:30%"><strong>{{ trans('WebSite.category') }}</strong></td>
            <td style="padding : 5px ; font-family: poppins,arialuni;">{{ Helper::translate($datas['inqdet'][0]['category'],$trans_arr) }}</td>
        </tr>
        {{-- <tr style="  font-weight:500; font-family: poppins,arialuni;">
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">
                @php
                    $txt = Helper::translate($datas['inqdet'][0]['fabric_composition'],$trans_arr);
                    if($datas['data']['fabric_type']!="")
                        $txt.= ", ".Helper::translate($datas['data']['fabric_type'],$trans_arr);
                    if($datas['data']['fabric_GSM']!="")
                        $txt.= ", ".Helper::translate($datas['data']['fabric_GSM'],$trans_arr)." GSM";
                    if($datas['data']['yarn_count']!="")
                        $txt.= ", Ne ".Helper::translate($datas['data']['yarn_count'],$trans_arr)." count";
                @endphp
                {{ $txt }}
            </td>
        </tr>
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{{ Helper::translate($datas['inqdet'][0]['income_terms'],$trans_arr) }}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['payment_terms'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['payment_instructions'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['style_article_description'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['special_finish'],$trans_arr) !!}</td>
        </tr>
        @endif
                    ...
                    if(!empty($datas['sku'])){
                        ...
                        echo '</tr>';
                            foreach($datas['colors'] as $cols){
                                echo '<tr>';
                                echo '<td><strong>'.Helper::translate($cols['name'],$trans_arr).'</strong></td>';
                                foreach($datas['sizes'] as $size){
                                    $vv = Helper::getIndexvalue($size['id'], $cols['id'], (array)$datas['sku']);
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['patterns'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['jurisdiction'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['customs_declaraion_document'],$trans) !!}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['penality'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['print_type'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['main_lable'],$trans_arr) !!}</td>
        </tr>
        @endif
        {{-- <tr style="font-weight:500; font-family: poppins,arialuni;">
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['washcare_lable'],$trans_arr) !!}</td>
        </tr>
        @endif
        {{-- <tr style="font-weight:500; font-family: poppins,arialuni;">
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['hangtag_lable'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['barcode_lable'],$trans_arr) !!}</td>
        </tr>
        @endif
        {{-- <tr style="font-weight:500; font-family: poppins,arialuni;">
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['trims_nominations'],$trans_arr) !!}</td>
        </tr>
        @endif
        <tr style="color:#009688; font-weight:500; font-family: poppins,arialuni;">
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['poly_bag_size'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['poly_bag_material'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['poly_bag_print'],$trans_arr) !!}</td>
        </tr>
        @endif
        {{-- <tr style="font-weight:500; font-family: poppins,arialuni;">
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['carton_bag_dimensions'],$trans_arr) !!} cm</td>
        </tr>
        @endif
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['carton_color'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['carton_material'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['carton_edge_finish'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['carton_mark'],$trans_arr) !!}</td>
        </tr>
        @endif
        {{-- <tr style="font-weight:500; font-family: poppins,arialuni;">
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['make_up'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['films_cd'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['picture_card'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['inner_cardboard'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['shipping_size'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['air_frieght'],$trans_arr) !!}</td>
        </tr>
        @endif
        <tr style="color:#009688; font-weight:500; font-family: poppins,arialuni;">
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['forbidden_substance_info'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['testing_requirements'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['sample_requirements'],$trans_arr) !!}</td>
        </tr>
        @endif
        ...
        <tr style="  font-weight:500; font-family: poppins,arialuni;">
            ...
            <td style="padding : 5px ; font-family: poppins,arialuni;">{!! Helper::translate($datas['data']['special_requests'],$trans_arr) !!}</td>
        </tr>
        @endif
            ...
            if($file['media_type']=='SampleFormat'){
                if(!stristr($file['orginalfilename'],'.pdf') && !stristr($file['orginalfilename'],'.ai')){
                    if($img_cnt==0){
                        ...
                        <div style="padding : 5px ; font-family: poppins,arialuni;text-align:center; font-size:15px; width:100%"><strong>{{ trans('WebSite.sample_images') }}</strong></div><?php
                    }
                    ?>
                    <p><img src="{{ $file['filepath'] }}" alt='Images' title="SampleFormat" style="padding:5px; margin-top:20px; max-width:90%"></p>
                    ...
                    ?>
                    <p style="width:100%;word-break: break-all"><a href="#" style="display: inline-block">{{ url('') }}/downloadfile?path={{ urlencode($file['org_file_path']) }}&filename={{ $file['orginalfilename'] }}</a></p><br>
                    <?php
                    $img_cnt++;*/
                    $ms_sheet_avil =1;
                }
            ...
            if($file['media_type']=='PrintImage'){
                if(!stristr($file['orginalfilename'],'.pdf') && !stristr($file['orginalfilename'],'.ai')){
                    if($img_cnt==0){
                        ?>
                        <div class="page-break"></div>
                        <div style="padding : 5px ; font-family: poppins,arialuni;text-align:center; font-size:15px; width:100%"><strong>{{ trans('WebSite.print_image') }}</strong></div><?php
                    }
                    ?>
                    <p><img src="{{ $file['filepath'] }}" alt='Images' title="PrintImage" style="padding:5px; margin-top:20px; max-width:90%"></p>
            ...
            if($file['media_type']=='MainLabel'){
                if(!stristr($file['orginalfilename'],'.pdf') && !stristr($file['orginalfilename'],'.ai')){
                    if($img_cnt==0){
                        ?>
                        <div class="page-break"></div>
                        <div style="padding : 5px ; font-family: poppins,arialuni;text-align:center; font-size:15px; width:100%"><strong>{{ trans('WebSite.main_label_sample') }}</strong></div><?php
                    }
                    ?>
                    <p><img src="{{ $file['filepath'] }}" alt='Images' title="MainLabel" style="padding:5px; margin-top:20px; max-width:90%"></p>
            ...
            if($file['media_type']=='WashCareLabel'){
                if(!stristr($file['orginalfilename'],'.pdf') && !stristr($file['orginalfilename'],'.ai')){
                    if($img_cnt==0){
                        ?>
                        <div class="page-break"></div>
                        <div style="padding : 5px ; font-family: poppins,arialuni;text-align:center; font-size:15px; width:100%"><strong>{{ trans('WebSite.washcare_label_sample') }}</strong></div><?php
                    }
                    ?>
                    <p><img src="{{ $file['filepath'] }}" alt='Images' title="WashCareLabel" style="padding:5px; margin-top:20px; max-width:90%"></p>
            ...
            if($file['media_type']=='Hangtag'){
                if(!stristr($file['orginalfilename'],'.pdf') && !stristr($file['orginalfilename'],'.ai')){
                    if($img_cnt==0){
                        ?>
                        <div class="page-break"></div>
                        <div style="padding : 5px ; font-family: poppins,arialuni;text-align:center; font-size:15px; width:100%"><strong>{{ trans('WebSite.hangtag_sample') }}</strong></div><?php
                    }
                    ?>
                    <p><img src="{{ $file['filepath'] }}" alt='Images' title="Hangtag" style="padding:5px; margin-top:20px; max-width:90%"></p>
            ...
            if($file['media_type']=='BarcodeStickers'){
                if(!stristr($file['orginalfilename'],'.pdf') && !stristr($file['orginalfilename'],'.ai')){
                    if($img_cnt==0){
                        ?>
                        <div class="page-break"></div>
                        <div style="padding : 5px ; font-family: poppins,arialuni;text-align:center; font-size:15px; width:100%"><strong>{{ trans('WebSite.barcode_stickers_sample') }}</strong></div><?php
                    }
                    ?>
                    <p><img src="{{ $file['filepath'] }}" alt='Images' title="BarcodeStickers" style="padding:5px; margin-top:20px; max-width:90%"></p>
            ...
            if($file['media_type']=='Polybag'){
                if(!stristr($file['orginalfilename'],'.pdf') && !stristr($file['orginalfilename'],'.ai')){
                    if($img_cnt==0){
                        ?>
                        <div class="page-break"></div>
                        <div style="padding : 5px ; font-family: poppins,arialuni;text-align:center; font-size:15px; width:100%"><strong>{{ trans('WebSite.polybag_sample') }}</strong></div><?php
                    }
                    ?>
                    <p><img src="{{ $file['filepath'] }}" alt='Images' title="Polybag" style="padding:5px; margin-top:20px; max-width:90%"></p>
            ...
            if($file['media_type']=='Carton'){
                if(!stristr($file['orginalfilename'],'.pdf') && !stristr($file['orginalfilename'],'.ai')){
                    if($img_cnt==0){
                        ?>
                        <div class="page-break"></div>
                        <div style="padding : 5px ; font-family: poppins,arialuni;text-align:center; font-size:15px; width:100%"><strong>{{ trans('WebSite.carton_sample') }}</strong></div><?php
                    }
                    ?>
                    <p><img src="{{ $file['filepath'] }}" alt='Images' title="Carton" style="padding:5px; margin-top:20px; max-width:90%"></p>
