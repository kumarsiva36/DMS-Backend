...
<body style="font-family: 'Roboto', sans-serif;">
    <div >
        <div class="wrapper" style="">
                <div style="line-height:25px;margin:5px 0px 0px 5px; text-align:center">
                    <span style="font-size:18px;"><strong>{{ trans('WebSite.due_today_task') }} ({{ date($details['dateFormat']) }})</strong></span>
                </div>
    ...
    <footer>
        <script type="text/php">
            ...
            $pdf->page_text(35, 805, "{{ trans('WebSite.due_today_task') }} ({{ date($details['dateFormat']) }})", $font, 10, array(0, 0, 0));
