...
<body style="font-family: poppins,arialuni; font-size: 14px;">
            ...
            <tr>
                ...
                <td width="25%">
                    <div style="float:right; font-size:20px; font-weight:600; color: #8C878D; ">
                        <strong>FBIN-{{ $data['inquiry_id'] }} {{ trans('WebSite.response') }} </strong>
                        <div
    ...
    <tr style="background-color: #C4E1DD; color: #178677; font-weight:600;">
        ...
        <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp,poppins-semibold;"><strong>{{ trans('WebSite.supplier') }}</strong></td>
        <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp,poppins-semibold;"><strong>{{ trans('WebSite.contactName') }}</strong></td>
        <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp,poppins-semibold;"><strong>{{ trans('WebSite.phoneNumber') }}</strong></td>
        <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp,poppins-semibold;"><strong>{{ trans('WebSite.price') }}</strong></td>
        <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp,poppins-semibold;"><strong>{{ trans('WebSite.comment') }}</strong></td>
    </tr>
    @foreach ($data['responses'] as $index=>$response)
        <tr>
            ...
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;">{{ $response['supplier'] }}</td>
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;">{{ $response['contact_person'] }}</td>
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;">{{ $response['contact_number'] }}</td>
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;">{{ $response['currency'].".".$response['price'] }}</td>
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;">{!!$response['comments']!!}</td>
        </tr>
    @endforeach
    </table>
    <footer>
