...
<body style="font-family: 'Roboto', sans-serif;">
    <div >
        <div class="wrapper" style="">
                <div style="line-height:25px;margin:5px 0px 0px 5px; text-align:center">
                    <span style="font-size:18px;"><strong>{{ trans('WebSite.delay_order_status') }} ({{ isset($details_arr[0]['dateFormat']) ? date($details_arr[0]['dateFormat']):"-" }})</strong></span>
                </div>
    ...
    <footer>
        <script type="text/php">
            ...
            $pdf->page_text(35, 805, "{{ trans('WebSite.delay_order_status') }} ({{ date($details_arr[0]['dateFormat']) }})", $font, 10, array(0, 0, 0));
