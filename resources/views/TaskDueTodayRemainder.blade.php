                            ...
                            @for($j=0; $j < $details['count']; $j++)
                                    ...
                                    <table style="width :100%; border-collapse: collapse;" >
                                        <tr>
                                            ...
                                            <?php $i++; $buyer_i++; ?>
                                                ...
                                                <td style="text-align: right; width: 15%;font-size:14px;font-family: 'Roboto', sans-serif;">
                                        ...
                                        <tr>
                                            ...
                                            <?php $i++; ?>
                                                ...
                                                <td style="text-align: right; width: 5%;font-size:14px;font-family: 'Roboto', sans-serif;">
                                                    <strong>{{ $details['pcu'][$j] }}</strong>
                                                </td>
                                            @endif
                                    ...
                                    <table style="width :100%;font-family: 'Roboto', sans-serif;" id="DataTable" >
                                        <tr>
                                            ...
                                            <th class="tableClass" style="font-family: 'Roboto', sans-serif;">{{ trans('WebSite.due') }}</th>
                                        </tr>
                                        <?php $i=1?>
                                        @foreach ($details['taskDetails'][$j] as $detail)
                                            <tr>
                                                ...
                                                <td class="tableClass" style="font-family: 'Roboto', sans-serif;">{{ trans('WebSite.today') }}</td>
                                            </tr>
                                        @endforeach
                                    </table>
                                @endfor
                    ...
                    <div class="wrapper" style="margin:50px 0;padding:20px 0">
                        <div >
                            <a href="{{ config('app.logo_url') }}" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">
                                <img src="{{ $message->embed(public_path().'/images/DMS-Logo.png') }}" width="125" style="margin-bottom: 5px;">
                            </a>
                        </div>
                        <div style="border:1px solid #eee; padding: 0px 10px 05px 10px; width:730px;  ">
                            <div style="line-height:25px;padding:10px 0px 0px 5px;">
                            ...
                            <div style="margin-top: 35px;">
                                <div style="text-align: center">
                                    <img src="{{ $message->embed(public_path().'/images/TaskRemainderWithBackground.png') }}" width="59" height="59">
                                </div>
                                <div style="font-weight: 600; color: #FE9738;text-align:center; font-size:20px; margin-bottom:0px;">{{ trans('WebSite.taskReminder') }}</div>
                                @for($j=0; $j < $details['count']; $j++)
                                    <table style="width :100%; border-collapse: collapse;margin-top:35px;" cellpadding="5">
                                        <tr>
                                            <td style="text-align: left; width: 8%;font-size:14px;font-family: 'Roboto', sans-serif;">
                                                {{ trans('WebSite.date') }}
                                            </td>
                                    ...
                                    <table style="width :100%;font-family: 'Roboto', sans-serif;" id="DataTable">
                                        <tr>
                                            ...
                                            <th class="tableClass" style="font-family: 'Roboto', sans-serif;">&nbsp;&nbsp;<span>{{ trans('WebSite.due') }}</span></th>
                                        </tr>
                                        <?php $i=1?>
                                        @foreach ($details['taskDetails'][$j] as $detail)
                                            <tr>
                                                ...
                                                <td class="tableClass" style="font-family: 'Roboto', sans-serif;">&nbsp;&nbsp;<span>{{ trans('WebSite.today') }}</span></td>
                                            </tr>
                                        @endforeach
                                    </table>
                                @endfor
