        ...
        <div class="wrapper" style="margin:50px 0;padding:20px 0">
          ...
          <div style="border:1px solid #eee; padding: 0px 10px 05px 10px;  ">
            ...
            <div style="margin-top: 35px;">
                <div>
                    <img src="{{ $message->embed(public_path().'/images/UserRegistrationIcon.png') }}" class="center">
                    {{-- <img src="{{ asset('images/UserRegistrationIcon.png') }}" class="center"> --}}
                </div>
                <div style="font-weight: 600; color: #188676;text-align:center; font-size:20px; margin-bottom:10px;">{{ trans('WebSite.welcomeToDMS') }}</div>
                <div style="margin:0px 5px;text-align:center;">
                    <p style="font-weight: 600;margin-bottom:8px;">{{ trans('WebSite.thankyouChoosing') }}</p>
                    <p style="margin-top:5px;">{{ trans('WebSite.enjoyableExperience') }}</p>
                </div>
            </div>
        </div>
