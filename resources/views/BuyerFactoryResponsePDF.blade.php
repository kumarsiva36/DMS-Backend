...
<body style="font-family: poppins,arialuni; font-size: 14px;">
            ...
            <tr>
                ...
                <td width="25%">
                    <div style="float:right; font-size:20px; font-weight:600; color: #8C878D; ">
                        <strong>IN-{{ $data['inquiry_id'] }} {{ trans('WebSite.response') }} </strong>
                        <div
    ...
    <tr style="background-color: #C4E1DD; color: #178677; font-weight:600;">
        ...
        <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp,poppins-semibold;"><strong>{{ trans('WebSite.Factory') }}</strong></td>
    ...
    @foreach ($data['responses'] as $index=>$response)
        <tr>
            ...
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;">{{ $response['factory'] }}</td>
