...
<body style="font-family: poppins,arialuni; font-size: 14px;">
            ...
            <tr>
                ...
                <td width="25%">
                    <div style="float:right; font-size:20px; font-weight:600; color: #8C878D; ">
                        <strong>{{ trans('WebSite.fabric_inquiry') }} </strong>
                        <div
    ...
    <tr style="background-color: #C4E1DD; color: #178677; font-weight:600;">
        ...
        <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp,poppins-semibold;"><strong>{{ trans('WebSite.yarn_count') }}</strong></td>
        <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp,poppins-semibold;"><strong>{{ trans('WebSite.yarn_quantity') }}</strong></td>
        <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp,poppins-semibold;"><strong>{{ trans('WebSite.meterial') }}</strong></td>
        <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp,poppins-semibold;"><strong>{{ trans('WebSite.composition') }}</strong></td>
        <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp,poppins-semibold;"><strong>{{ trans('WebSite.delivery_date') }}</strong></td>
    </tr>
    @foreach ($data['inquiries'] as $index=>$inquiry)
        <tr>
            ...
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;">{{ "FBIN-".$inquiry['id'] }}</td>
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;">{{ $inquiry['yarn_count'] }}</td>
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;">{{ $inquiry['yarn_quantity'] }}</td>
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;">{{ $inquiry['meterial'] }}</td>
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;">{{ $inquiry['composition'] }}</td>
            <td style="padding : 5px 5px 10px 20px; font-family: poppins,arialuni,notosansjp;">
                {{ date($data['dateFormat'],strtotime($inquiry['delivery_date'])) }}</td>
