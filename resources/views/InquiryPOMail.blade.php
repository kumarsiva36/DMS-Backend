        ...
        <div class="wrapper" style="margin:50px 0;padding:20px 0">
          ...
          <div style="border:1px solid #eee; padding: 0px 10px 05px 10px;  ">
            <div style="line-height:25px;margin:10px 0px 0px 5px;">
                ...
                Please find enclosed our detailed PO for below mentioned. Please workthrough all details carefully. If something in your offer will differ from this PO please let us know exactly what you otherwise we will take our requests as granted!
                <br><br>
            </div>
