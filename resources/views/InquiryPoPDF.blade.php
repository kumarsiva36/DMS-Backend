        ...
        <table width="100%"  cellpadding="0" cellspacing="0" class="mainTable" >
            <tr>
                ...
                <td style="vertical-align:middle;text-align:center;font-size:12px; font-weight:600; color: #8C878D;">
                        <strong>{{ trans('WebSite.Po') }} from - {{ $datas['user']['name'] }} ({{ $datas['user']['user_type'] }})</strong>
                </td>
                <td width="15%">
                    <div style="vertical-align:middle;text-align:right; font-size:12px; font-weight:600; color: #8C878D; ">
                        <strong>{{ trans('WebSite.Po') }} - {{ $datas['poID'] }}</strong>
                        {{-- <div
                ...
                foreach($datas['media']['files'] as $file){
                    if($file['media_type']=='MeasurementSheet'){
                        ...
                        <tr style="  font-weight:500; font-family: poppins,arialuni;">
                            ...
                            <td style="padding : 5px ; font-family: poppins,arialuni;">
                                <?php
                                echo '<a href='.$datas['media']['serverURL'].$file['filepath'].'>'.$file['orginalfilename'].'</a>';
    ...
    @if($ms_sheet_avil==0)
        <footer>
            <script type="text/php">
                ...
                $pdf->page_text(35, 805, "PO-{{ $datas['poID'] }}    {{ date('d M Y',strtotime($datas['inqdet'][0]['created_date'])) }}", $font, 10, array(0, 0, 0));
