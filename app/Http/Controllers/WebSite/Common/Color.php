...
class Color extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $res = json_encode(['status_code'=>200,'status'=>'success','data'=>$getColors]);
        return CommonApp::webEncrypt($res);
    }
    ...
    public function store(Request $request)
    {
        ...
        $createdBy = isset($request->created_by) ?? 0;
        $whereCondition=[
            ['name','=',$name],
        ...
        if(empty($existsColor)){
            ...
            $res = json_encode(['status_code'=>200, 'status'=>'success','message' => "Color Added Succesfully"]);
            return CommonApp::webEncrypt($res);
        }else{
            $res = json_encode(['status_code'=>400, 'status'=>'success','message' => "Color Name Already Exists"]);
            return CommonApp::webEncrypt($res);
        }
    }
