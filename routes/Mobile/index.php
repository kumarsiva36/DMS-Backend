...
use App\Http\Controllers\Mobile\Common\Countries;
use App\Http\Controllers\Mobile\Auth\Roles;
use App\Http\Controllers\Mobile\Auth\Staffs;
use App\Http\Controllers\Mobile\Auth\Users;
use App\Http\Controllers\Mobile\Common\Size;
use App\Http\Controllers\Mobile\Common\Color;
use App\Http\Controllers\Mobile\Common\DashBoard;
use App\Http\Controllers\Mobile\Common\DashboardNew;
use App\Http\Controllers\Mobile\Common\HolidaySettings;
use App\Http\Controllers\Mobile\Company\CompanySettings;
use App\Http\Controllers\Mobile\Order\AddOrder;
use App\Http\Controllers\Mobile\Order\AddOrderContacts;
use App\Http\Controllers\Mobile\Order\AddOrderProduction;
use App\Http\Controllers\Mobile\Order\AddOrderSKU;
use App\Http\Controllers\Mobile\Order\ArticleNames;
use App\Http\Controllers\Mobile\Order\EditOrders\EditOrder;
use App\Http\Controllers\Mobile\Order\FabricTypes;
use App\Http\Controllers\Mobile\Order\Factories;
use App\Http\Controllers\Mobile\Order\IncomeTerms;
use App\Http\Controllers\Mobile\Order\OrderCategories;
use App\Http\Controllers\Mobile\Order\OrderTasks;
use App\Http\Controllers\Mobile\Order\OrderTemplates;
use App\Http\Controllers\Mobile\Order\PCUs;
use App\Http\Controllers\Mobile\User\Register;
use App\Http\Controllers\Mobile\Plan\ActivePlans;
use App\Http\Controllers\Mobile\Common\UserSettings;
use App\Http\Controllers\Mobile\Common\StaffSettings;
use App\Http\Controllers\Mobile\Common\WeekOffs;
use App\Http\Controllers\Mobile\Order\BasicInfo;
use App\Http\Controllers\Mobile\Order\OrderAddSpecs;
use App\Http\Controllers\Mobile\Order\Buyers;
use App\Http\Controllers\Mobile\Order\DataInput\AddMultipleData;
use App\Http\Controllers\Mobile\Order\DataInput\GetCalendarData;
use App\Http\Controllers\Mobile\Order\EditOrders\EditContacts;
use App\Http\Controllers\Mobile\Order\EditOrders\EditProduction;
use App\Http\Controllers\Mobile\Order\EditOrders\EditSKU;
use App\Http\Controllers\Mobile\Order\EditOrders\EditTasks;
use App\Http\Controllers\Mobile\Order\GetOrder\GetOrder;
use App\Http\Controllers\Mobile\Order\GetOrder\GetStyle;
use App\Http\Controllers\Mobile\Order\RescheduleOrderTasks;
use App\Http\Controllers\Mobile\Order\GetOrder\GetOrderRegistrationPageDropDownDetails;
use App\Http\Controllers\Mobile\Order\GetOrderSkuDefaultColorandSize;
use App\Http\Controllers\Mobile\Order\GetOrder\GetOrderDetails;
use App\Http\Controllers\Mobile\Common\TimezoneFormatSetting;
use App\Http\Controllers\Mobile\Inquiry\Inquiry;
use App\Http\Controllers\Mobile\Order\SubTask;
use App\Http\Controllers\Mobile\Fabric\Fabric;
use App\Http\Controllers\Mobile\Inquiry\InquiryChat;
use App\Http\Controllers\Mobile\PurchaseOrder\PO;
use App\Http\Controllers\Mobile\TechPack\TeckPackDetail;
